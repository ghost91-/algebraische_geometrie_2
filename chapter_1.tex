...
\begin{defn}
	Ein \textbf{Homomorhismus} $\varphi: \mathcal{F} \to \mathcal{G}$ \textbf{von (Prä-)Garben} auf $x$ ist eine Familie von Homomorphismen $\varphi_U:\mathcal{F}(U) \to \mathcal{G}(U)$ abelscher Gruppen für alle $U$ offen in $X$, sodass
	\begin{center}
		\begin{tikzcd}
...
\begin{prop}
	...
	\end{proof}
	Beachte, dass diese Aussage nicht für Prögarben gilt.
\end{prop}