...
\label{prop:1.17}
	...
	\begin{center}
		\begin{tikzcd}
			\mathcal{F} \arrow{r}{\varphi} \arrow{d}{\Theta} & \mathcal{G} \arrow{d}{\Theta}\\
	...
	\begin{proof}[Beweisskizze]
		...
		\begin{center}
			\begin{tikzcd}
				S \arrow{rr}{\psi} \arrow{rd}{\pi} & & T \arrow{dl}{\pi}\\
				& X
			\end{tikzcd}
		\end{center}
		kommutiert.
...
\begin{kor}[Universelle Eigenschaft von $\mathcal{F}^+$]
	...
	\begin{center}
		\begin{tikzcd}
			\mathcal{F} \arrow{r}{\varphi} \arrow{d} & \mathcal{G}\\
			\mathcal{F}^+ \arrow{ur}{\varphi_+}
		\end{tikzcd}
	\end{center}
	kommutiert.
	\begin{proof}
