...
\label{defn:6.8}
	...
	\begin{enumerate}[i)]
		...
		\item\label{defn:6.8:iv} $f$ heißt \textbf{lokal von endlichem Typ}, wenn für alle affinen offenen Unterschemata $V=\Spec(A)$ von $Y$ und jedes affine offene Unterschema $U = \Spec(B)$ in $f^{-1}(V)$ schon $B$ eine endlich erzeugte $A$-Algebra ist vermöge der Abbildung
		\[
