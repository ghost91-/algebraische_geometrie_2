...
\begin{bem}
\label{bem:8.7}
	Man kann zeigen, dass der $X_p$ zugrunde liegende topologische Raum homöomorph zu $f^{-1}(\{p\})$ mit der induzierten Topologie (siehe \cite[{}I.3.6.1]{grothendieck1960elements} oder \cite[Exercise~II.3.10]{hartshorne1977algebraic} oder \cite[Proposition4.20 und (4.8)]{goertz2010algebraic}).
\end{bem}
