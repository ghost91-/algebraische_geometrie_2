...
\begin{bem}
\label{bem:8.7}
	Man kann zeigen, dass der $X_p$ zugrunde liegende topologische Raum homöomorph zu $f^{-1}(\{p\})$ mit der induzierten Topologie (siehe \cite[I.3.4.6]{grothendieck1971elements} oder \cite[Exercise II.3.10]{hartshorne1977algebraic} oder \cite[Proposition 4.20 und (4.8)]{goertz2010algebraic}).
\end{bem}
...
\label{prop:8.11}
	...
	\begin{proof}
		...
		\begin{center}
			\begin{tikzcd}
				(X'\coloneqq X \times_Y Y') \arrow{d}{g'} \arrow{r}{f'} & Y' \arrow{d}{g}\\ X \arrow{r}{f} & Y\mathrlap{,}
			\end{tikzcd}
		\end{center}
