...
\begin{proof}[Beweis von Theorem~\ref{thm:8.2}]
	...
	\begin{proof}
		...
		\begin{center}
			\begin{tikzcd}
				C\\
				{} & A \otimes B\arrow[dashed]{ul}[swap]{\exists! \; \varphi} & B\arrow[bend right, start anchor=north]{llu}[swap]{\varphi_2}\arrow{l}[swap]{\Spec(p_2)}\\
